...
Route::get('admin/index', 'Admin\MypageController@index'); //保護者マイページ
...
Route::get('renraku/index', 'Admin\MypageController@renraku'); //連絡ノート一覧


Route::get('notice/create', 'NoticeController@create'); //お知らせ投稿
Route::get('notice/edit', 'NoticeController@edit'); //お知らせ編集
Route::get('notice/index', 'NoticeController@index'); //お知らせ一覧
