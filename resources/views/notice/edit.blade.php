    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <h2>お知らせ編集</h2>
                <form action="{{ action('NoticeController@edit') }}" method="post" enctype="multipart/form-data">
                    @if (count($errors) > 0)
                        <ul>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="title" value="{{ $notice_form->title }}">
                        </div>
                    </div>
                    <div class="form-group row">
